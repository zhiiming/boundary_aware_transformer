...
1. Test PSPNet and visualize the results. Press any key for the next image.
    ...
    ```shell
    python tools/test.py configs/comparison/pspnet_r50-d8_512x1024_40k_cityscapes.py \
...
3. Test PSPNet on PASCAL VOC (without saving the test results) and evaluate the mIoU.
    ...
    ```shell
    python tools/test.py configs/comparison/pspnet_r50-d8_512x1024_20k_voc12aug.py \
...
4. Test PSPNet with 4 GPUs, and evaluate the standard mIoU and cityscapes metric.
    ...
    ```shell
    ./tools/dist_test.sh configs/comparison/pspnet_r50-d8_512x1024_40k_cityscapes.py \
        checkpoints/pspnet_r50-d8_512x1024_40k_cityscapes_20200605_003338-2966598c.pth \
