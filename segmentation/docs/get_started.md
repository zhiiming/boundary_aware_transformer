...
config_file = 'configs/comparison/pspnet_r50-d8_512x1024_40k_cityscapes.py'
...
```shell
python demo/image_demo.py demo/demo.jpg configs/comparison/pspnet_r50-d8_512x1024_40k_cityscapes.py \
